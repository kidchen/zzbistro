  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-xl md:text-3xl font-bold text-gray-900">Recipe Collection 📖</h1>
        <Link
          href="/recipes/new"
              ...
              <div key={recipe.id} className={`p-4 ${index < filteredRecipes.length - 1 ? 'border-b border-gray-200' : ''}`}>
                <div className="flex gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-sm font-semibold text-gray-900 mb-1 truncate">{recipe.name}</h3>
